...
const applyDepartmentDAO = require('../models/program/applyDepartmentDAO')
const jwtmiddle = require('../middleware/jwt');
const dayjs = require('dayjs');

async function programAll(req, res, next) {
...
async function programAllApp(req, res, next) {
...
async function myprogramAll(req, res, next) {
    let jwt_token = req.cookies.student;
    let parameters = {}
    try {
        if (jwt_token == undefined) { throw "로그인 정보가 없습니다." }
...
async function deleteUserProgram(req, res, next) {
    let jwt_token = req.cookies.student;
    let parameters = {
...
async function programWrite(req, res, next) {
...
async function programUserAnswer(req, res, next) {
    let jwt_token = req.cookies.student;
